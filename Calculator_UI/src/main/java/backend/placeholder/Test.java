package backend.placeholder;

import java.util.Comparator;
import java.util.List;
import java.util.stream.Collectors;

import backend.helper.RandomValueGenerator;
import backend.model.ComputeEmpty;
import backend.model.ComputeMaximum;
import backend.model.ComputeMean;
import backend.model.ComputeMeanAbsoluteDeviation;
import backend.model.ComputeMedian;
import backend.model.ComputeMinimum;
import backend.model.ComputeMode;
import backend.model.ComputeObserver;
import backend.model.ComputeStandardDeviation;
